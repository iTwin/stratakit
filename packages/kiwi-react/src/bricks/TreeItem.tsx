		...
		return (
			<TreeItemContext.Provider
				value={React.useMemo(
					...
					[level, expanded, selected, errorId],
				)}
			>
				<CompositeItem
					render={<Role {...rest} />}
...
DEV: TreeItemError.displayName = "TreeItem.Error";
...
DEV: TreeItemErrorAction.displayName = "TreeItem.ErrorAction";
...
export {
	...
	TreeItemError as Error,
	TreeItemErrorAction as ErrorAction,
};
