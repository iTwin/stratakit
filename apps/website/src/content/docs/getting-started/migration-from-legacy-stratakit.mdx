...
- Use `variant="inline"` to display the badge in [normal document flow](/components/badge/#inline).
...
- Replace [`Table.Caption`](/reference/bricks/Table#Table.Caption) with a native HTML [`<caption>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/caption) element inside [`Table`](https://mui.com/material-ui/api/table/) component.
