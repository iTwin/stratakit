...
Error messages must actively [help the user to resolve the error](https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion.html). If your application includes messages like _“Error 41”_, _“Incorrect format”_, or _“Please try again”_, users will not know how to proceed.
