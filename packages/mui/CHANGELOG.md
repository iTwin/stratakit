...
- [#1288](https://github.com/iTwin/stratakit/pull/1288): Removed all values for the `color` prop from `Chip`.
- [#1294](https://github.com/iTwin/stratakit/pull/1294): Removed `"default"` value from `color` prop of `IconButton` component. The default color is now `"secondary"`.
- [#1332](https://github.com/iTwin/stratakit/pull/1332): Removed `LinkComponent` prop from `ButtonBase` (and therefore from all MUI components that extend it). Use the `render` prop instead.
...
- [#1287](https://github.com/iTwin/stratakit/pull/1287): Removed `"default"` value from `color` prop of `Badge` component. The default color is now `"secondary"`.
...
- [#1276](https://github.com/iTwin/stratakit/pull/1276): Fixed the colors of various permuations of `Alert`.
...
- [#1307](https://github.com/iTwin/stratakit/pull/1307): Fixed contrast of `BottomNavigation` selected item.
...
- [#1268](https://github.com/iTwin/stratakit/pull/1268): Added `render` prop to `Root` component.
...
- [#1287](https://github.com/iTwin/stratakit/pull/1287): Added `inline` prop to `Badge` component to display the badge in normal document flow instead of positioned relative to its child.
...
- [#1271](https://github.com/iTwin/stratakit/pull/1271): Removed unnecessary `role="button"` from `CardActionArea` to avoid conflicts when it's rendered as a link.
