import{E as C,F as b,H as k,j as i,C as w,J as x,K as R,N as S,a6 as c,a7 as m}from"./~utils.BtJdAKIN.js";import{r as $}from"./index.DIfZGIpv.js";import{v as U}from"./visuallyHidden.Dan1xhjv.js";import"./index.XeJbqeyU.js";import"./styles.internal.BMgQUzYF.js";function j(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:r,height:o}=t;return x({root:["root",a,n,s&&"withChildren",s&&!r&&"fitContent",s&&!o&&"heightAuto"]},A,e)},l=m`
  0% {
    opacity: 1;
  }
