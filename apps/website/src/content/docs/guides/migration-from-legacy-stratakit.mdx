...
This guide provides the necessary steps for migrating from legacy StrataKit packages (`@stratakit/foundations`, `@stratakit/bricks`, and `@stratakit/structures`) to [Material UI](https://mui.com/material-ui/getting-started/) based StrataKit implementation.
...
3. **Replace `@stratakit/bricks` with `@mui/material`**
   ...
   Replace the usage of components from `@stratakit/bricks` with their MUI counterparts. Refer to the [use MUI components](#use-mui-components) below for the component mapping and additional guidance.
...
- Change [`AccordionItem.Root`](/reference/structures/AccordionItem/#AccordionItem.Root) component to [`Accordion`](https://mui.com/material-ui/api/accordion/) component. Use [Accordion examples](/components/accordion/#examples) for reference.
...
- Change [`Banner`](/reference/structures/Banner#Banner), [`Banner.Root`](/reference/structures/Banner#Banner.Root) components to [`Alert`](https://mui.com/material-ui/api/alert/) component. Use [Alert examples](/components/alert/#examples) for reference.
...
- Change [`Chip`](/reference/structures/Chip#Chip), [`Chip.Root`](/reference/structures/Chip#Chip.Root) components to [`Chip`](https://mui.com/material-ui/api/chip/) component. Use [Chip examples](/components/chip/#examples) for reference.
