...
This section is for **application** developers. If you're building a package on top of StrataKit, you can usually skip most of these steps, since the host application will already have StrataKit set up for you.
...
If you're using StrataKit alongside the current stable version of iTwinUI, see [Migrating from iTwinUI](/getting-started/migration-from-itwinui).
