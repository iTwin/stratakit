...
See [CHANGELOG.md](https://github.com/iTwin/stratakit/blob/%40stratakit/foundations%401.0.0-rc.2/packages/foundations/CHANGELOG.md) in `@stratakit/foundations@1.0.0-rc.2` for a list of changes in the `1.0.0-rc.*` releases. These changes are included in the `1.0.0` release.
