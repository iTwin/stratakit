...
This guide is for **application** developers. If you're building a package on top of StrataKit, you can usually skip most of these steps, since the host application will already have StrataKit set up for you. See [Building packages](/getting-started/build-packages) for more information.
