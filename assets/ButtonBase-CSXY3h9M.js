...
`;function oe(e){if(e.motion.reducedMotion===`always`)return null;let t=l`
    &.${P.rippleVisible} {
      animation-name: ${ae};
  ...
  `;return e.motion.reducedMotion===`system`?l`
    ...
    `:t}var se=o(`span`,{name:`MuiTouchRipple`,slot:`Root`})({overflow:`hidden`,pointerEvents:`none`,position:`absolute`,zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:`inherit`}),ce=o(N,{name:`MuiTouchRipple`,slot:`Ripple`})`
  opacity: 0;
  position: absolute;
  ...
  ${({theme:e})=>oe(e)}
`,le=v.forwardRef(function(e,t){let n=c({props:e,name:`MuiTouchRipple`}),i=V(g().motion.reducedMotion,!1),{center:a=!1,classes:o=U,className:s,...l}=n,[u,d]=v.useState({items:W,order:W}),f=u.items,p=v.useRef(0),m=v.useRef(null),h=v.useRef(!1);k(()=>(h.current=!0,()=>{h.current=!1})),v.useEffect(()=>{m.current&&=(m.current(),null)},[f]);let _=v.useRef(!1),b=j(),x=v.useRef(null),S=v.useRef(null),C=y(e=>{h.current&&d(t=>{let n=t.items.filter(t=>t.key!==e);return{items:n,order:K(t.order.filter(t=>t!==e),n.filter(e=>!e.exiting).map(e=>e.key))}})}),w=y(e=>{let{pulsate:t,rippleX:n,rippleY:r,rippleSize:i,cb:a}=e,o=p.current;p.current+=1,d(e=>{let a=[...e.items,{key:o,pulsate:t,rippleX:n,rippleY:r,rippleSize:i,exiting:!1}];return{items:a,order:K(e.order,a.filter(e=>!e.exiting).map(e=>e.key))}}),m.current=a}),T=y((e=U,t=U,n=G)=>{let{pulsate:r=!1,center:i=a||t.pulsate,fakeElement:o=!1}=t;if(e?.type===`mousedown`&&_.current){_.current=!1;return}e?.type===`touchstart`&&(_.current=!0);let{rippleX:s,rippleY:c,rippleSize:l}=q({event:e,element:o?null:S.current,center:i});e?.touches?x.current===null&&(x.current=()=>{w({pulsate:r,rippleX:s,rippleY:c,rippleSize:l,cb:n})},b.start(80,()=>{x.current&&=(x.current(),null)})):w({pulsate:r,rippleX:s,rippleY:c,rippleSize:l,cb:n})}),E=y(()=>{T(U,{pulsate:!0})}),D=y((e,t)=>{if(b.clear(),e?.type===`touchend`&&x.current){x.current(),x.current=null,b.start(0,()=>{D(e,t)});return}x.current=null,d(e=>{let t=e.items.findIndex(e=>!e.exiting);if(t===-1)return e;let n=e.items.slice();return n[t]={...n[t],exiting:!0},{items:n,order:K(e.order,n.filter(e=>!e.exiting).map(e=>e.key))}}),m.current=t});v.useImperativeHandle(t,()=>({pulsate:E,start:T,stop:D}),[E,T,D]);let O=new Map(f.map(e=>[e.key,e])),A=u.order.map(e=>O.get(e)).filter(Boolean);return(0,M.jsx)(se,{className:r(P.root,o.root,s),ref:S,...l,children:A.map(e=>(0,M.jsx)(ce,{classes:{ripple:r(o.ripple,P.ripple),rippleVisible:r(o.rippleVisible,P.rippleVisible),ripplePulsate:r(o.ripplePulsate,P.ripplePulsate),child:r(o.child,P.child),childLeaving:r(o.childLeaving,P.childLeaving),childPulsate:r(o.childPulsate,P.childPulsate)},timeout:i.shouldReduceMotion?0:H,pulsate:e.pulsate,rippleX:e.rippleX,rippleY:e.rippleY,rippleSize:e.rippleSize,in:!e.exiting,onExited:()=>C(e.key)},e.key))})});function X(e){return i(`MuiButtonBase`,e)}var Z=d(`MuiButtonBase`,[`root`,`disabled`,`focusVisible`]),ue=e=>{let{disabled:t,focusVisible:n,focusVisibleClassName:r,suppressFocusVisible:i,classes:a}=e,o=s({root:[`root`,t&&`disabled`,n&&!i&&`focusVisible`]},X,a);return n&&!i&&r&&(o.root+=` ${r}`),o},de=o(`button`,{name:`MuiButtonBase`,slot:`Root`})(f(({theme:e})=>({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,position:`relative`,boxSizing:`border-box`,WebkitTapHighlightColor:`transparent`,backgroundColor:`transparent`,outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:`pointer`,userSelect:`none`,verticalAlign:`middle`,MozAppearance:`none`,WebkitAppearance:`none`,textDecoration:`none`,color:`inherit`,"&::-moz-focus-inner":{borderStyle:`none`},[`&.${Z.disabled}`]:{pointerEvents:`none`,cursor:`default`},"@media print":{colorAdjust:`exact`},variants:[{props:{internalDisabledThemeFocusVisible:!1},style:e.focusVisible&&{...a,[`&.${Z.focusVisible}`]:e.focusVisible}}]}))),fe=v.forwardRef(function(e,t){let n=c({props:e,name:`MuiButtonBase`}),{action:i,centerRipple:a=!1,children:o,className:s,component:l=`button`,disabled:u=!1,disableRipple:d=!1,disableTouchRipple:f=!1,focusRipple:p=!1,focusVisibleClassName:m,focusableWhenDisabled:g,suppressFocusVisible:b=!1,internalNativeButton:x,internalDisabledThemeFocusVisible:C=!1,LinkComponent:w=`a`,nativeButton:T,onBlur:D,onClick:O,onContextMenu:k,onDragLeave:A,onFocus:j,onFocusVisible:N,onKeyDown:P,onKeyUp:F,onMouseDown:ee,onMouseLeave:I,onMouseUp:te,onTouchEnd:L,onTouchMove:ne,onTouchStart:re,tabIndex:R=0,TouchRippleProps:z,touchRippleRef:ie,type:B,...V}=n,H=!!(V.href||V.to),U=!!V.formAction,W=l;W===`button`&&H&&(W=w);let G=typeof W==`string`?W===`button`:x??!1,K=T??G,q=E(),ae=h(q.ref,ie),[J,Y]=v.useState(!1);(u||b)&&J&&Y(!1);let oe=y(e=>{p&&!e.repeat&&J&&e.key===` `&&q.stop(e,()=>{q.start(e)})}),se=y(e=>{p&&e.key===` `&&J&&!e.defaultPrevented&&q.stop(e,()=>{q.pulsate(e)})}),{getButtonProps:ce,rootRef:X}=S({nativeButton:K,nativeButtonProp:T,internalNativeButton:G,allowInferredHostMismatch:H||typeof W==`string`,disabled:u,type:B,hasFormAction:U,tabIndex:R,onBeforeKeyDown:oe,onBeforeKeyUp:se}),{onClick:Z,onKeyDown:fe,onKeyUp:pe,...me}=ce({onClick:O,onKeyDown:P,onKeyUp:F});v.useImperativeHandle(i,()=>({focusVisible:()=>{Y(!0),X.current.focus()}}),[X]);let he=q.shouldMount&&!d&&!u;v.useEffect(()=>{J&&p&&!d&&q.pulsate()},[d,p,J,q]);let ge=Q(q,`start`,ee,f),_e=Q(q,`stop`,k,f),ve=Q(q,`stop`,A,f),ye=Q(q,`stop`,te,f),be=Q(q,`stop`,e=>{J&&e.preventDefault(),I&&I(e)},f),xe=Q(q,`start`,re,f),Se=Q(q,`stop`,L,f),Ce=Q(q,`stop`,ne,f),we=Q(q,`stop`,e=>{_(e.target)||Y(!1),D&&D(e)},!1),Te=y(e=>{X.current||=e.currentTarget,!b&&_(e.target)&&(Y(!0),N&&N(e)),j&&j(e)}),$={};H&&($.tabIndex=u?-1:R,u&&($[`aria-disabled`]=u),$.type=B);let Ee=h(t,X),De={...n,centerRipple:a,component:l,disabled:u,disableRipple:d,disableTouchRipple:f,focusRipple:p,suppressFocusVisible:b,tabIndex:R,focusVisible:J,internalDisabledThemeFocusVisible:C},Oe=ue(De);return(0,M.jsxs)(de,{as:W,className:r(Oe.root,s),ownerState:De,onBlur:we,onClick:Z,onContextMenu:_e,onFocus:Te,onKeyDown:fe,onKeyUp:pe,onMouseDown:ge,onMouseLeave:be,onMouseUp:ye,onDragLeave:ve,onTouchEnd:Se,onTouchMove:Ce,onTouchStart:xe,ref:Ee,...H?$:me,...V,children:[o,he?(0,M.jsx)(le,{ref:ae,center:a,...z}):null]})});function Q(e,t,n,r=!1){return y(i=>(n&&n(i),r||e[t](i),!0))}export{j as a,A as i,Z as n,w as o,V as r,y as s,fe as t};