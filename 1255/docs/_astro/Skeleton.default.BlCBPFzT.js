import{O as C,P as b,Q as k,j as i,N as w,S as x,U as S,W as R,a3 as c,a4 as m}from"./ExamplePreview.BIj7EOVW.js";import{r as $}from"./index.DIfZGIpv.js";import{v as U}from"./visuallyHidden.Dan1xhjv.js";import"./preload-helper.bNjeYf3K.js";import"./index.XeJbqeyU.js";import"./styles.internal.BwFdDu8v.js";function j(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:r,height:o}=t;return x({root:["root",a,n,s&&"withChildren",s&&!r&&"fitContent",s&&!o&&"heightAuto"]},A,e)},l=c`
  0% {
    opacity: 1;
  }
