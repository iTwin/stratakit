import{Z as C,_ as b,$ as k,j as s,Y as w,a0 as x,a1 as R,a3 as S,ai as c,aj as m}from"./ExamplePreview.CmJAnI-4.js";import{r as $}from"./index.DIfZGIpv.js";import{v as j}from"./visuallyHidden.Dan1xhjv.js";import"./preload-helper.CWPvEUvb.js";import"./styles.internal.BwFdDu8v.js";import"./index.XeJbqeyU.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:i,width:r,height:o}=t;return x({root:["root",a,n,i&&"withChildren",i&&!r&&"fitContent",i&&!o&&"heightAuto"]},A,e)},l=c`
  0% {
    opacity: 1;
  }
