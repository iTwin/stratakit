...
export default defineConfig({
	...
	markdown: {
		processor: unified({
			remarkPlugins: [remarkDirective, remarkLiveExamples, remarkPrefixLinks],
...
/**
 * Rehype plugin that makes tables responsive by wrapping them in a `<responsive-table>` element.
 */
function rehypeWrapTables({ tagName = "responsive-table" } = {}) {
...
/**
 * Remark plugin that processes `::example{src="..."}` directives to embed live examples.
 *
...
/**
 * Remark plugin that prefixes all markdown links with the base URL.
 */
