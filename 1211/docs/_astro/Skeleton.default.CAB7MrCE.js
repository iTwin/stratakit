import{j as i,H as C,P as c,Q as m}from"./ExamplePreview.DU4bU6aQ.js";import{r as b}from"./index.DIfZGIpv.js";import{g as k,a as w,u as x,c as R,s as S,m as $}from"./DefaultPropsProvider.BIjONUyy.js";import{v as U}from"./visuallyHidden.Dan1xhjv.js";import"./preload-helper.Jh3gAXqj.js";import"./index.XeJbqeyU.js";import"./styles.internal.BwFdDu8v.js";function j(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return k("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:r,height:o}=t;return R({root:["root",a,n,s&&"withChildren",s&&!r&&"fitContent",s&&!o&&"heightAuto"]},A,e)},l=c`
  0% {
    opacity: 1;
  }
